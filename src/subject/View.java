...
public class View extends javax.swing.JFrame {
    ...
    public void sessionTable(){
        ...
        String[] colNames = {"Subject Code","Subject Name","Offered Year","Semester","Lecture Hours","Tute Hours","Lab Hours","Evaluation Hours"};
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 90, -1));
	...
	PreparedStatement preparedStatement;
        try{
            ...
            preparedStatement = connection.prepareStatement("SELECT * FROM subjects WHERE subjectCode=?");
